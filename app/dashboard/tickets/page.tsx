'use client'
import { GET_TICKETS_BY_USER_ID_QUERY, GET_INSTITUTIONS_QUERY, GET_REPORT_QUERY } from "@/apollo/queries";
...
}const TicketPageComponent2 = () => (
    <ApolloProvider client={client}>
        <TicketPages />
    </ApolloProvider>
);
TicketPageComponent2.displayName = 'TicketPageComponent2';
export default TicketPageComponent2;
